...
export class GenConstants {
  ...
  /** 数据库字符串类型 */
  public static readonly COLUMNTYPE_STR: string[] = [
    'char',
    'varchar',
    'nvarchar',
    'varchar2',
  ...
  /** 数据库文本类型 */
  public static readonly COLUMNTYPE_TEXT: string[] = [
    'tinytext',
    'text',
    'mediumtext',
    'longtext',
  ...
  /** 数据库时间类型 */
  public static readonly COLUMNTYPE_TIME: string[] = [
    'datetime',
    'time',
    'date',
    'timestamp',
  ...
  /** 页面不需要编辑字段 */
  public static readonly COLUMNNAME_NOT_EDIT: string[] = [
    'id',
    'create_by',
    'create_time',
    'del_flag',
  ...
  /** Entity基类字段 */
  public static readonly BASE_ENTITY: string[] = [
    'createBy',
    'createTime',
    'updateBy',
    'updateTime',
  ...
  /** Tree基类字段 */
  public static readonly TREE_ENTITY: string[] = [
    'parentName',
    'parentId',
    'orderNum',
    'ancestors',
  ...
  /** 整型 */
  public static readonly TYPE_INTEGER: string = 'number';

  /** 长整型 */
  public static readonly TYPE_LONG: string = 'number';

  /** 浮点型 */
  public static readonly TYPE_DOUBLE: string = 'number';

  /** 高精度计算类型 */
  public static readonly TYPE_BIGDECIMAL: string = 'string';
