...
export class SysDictDataRepository {
  ...
  async selectDictDataList(
    ...
    if (dictData.dictType) {
      queryBuilder.andWhere('d.dictType = :dictType', {
        dictType: dictData.dictType,
      });
    }
    if (dictData.dictLabel) {
      queryBuilder.andWhere('d.dictLabel LIKE :dictLabel', {
  ...
  selectDictDataVo() {
    const entityManager =
      ...
      this.dictDataRepository.manager;
    return entityManager
      .createQueryBuilder(SysDictData, 'd')
      .select([
        'd.dictCode',
        'd.dictSort',
        'd.dictLabel',
  ...
  async insertDictData(dictData: SysDictData): Promise<number> {
    ...
    if (dictData.dictLabel != null && dictData.dictLabel != '')
      insertObject.dictLabel = dictData.dictLabel;
    if (dictData.dictValue != null && dictData.dictValue != '')
      insertObject.dictValue = dictData.dictValue;
    if (dictData.dictType != null && dictData.dictType != '')
      insertObject.dictType = dictData.dictType;
    if (dictData.cssClass != null && dictData.cssClass != '')
      insertObject.cssClass = dictData.cssClass;
    if (dictData.listClass != null && dictData.listClass != '')
      insertObject.listClass = dictData.listClass;
    if (dictData.isDefault != null && dictData.isDefault != '')
      insertObject.isDefault = dictData.isDefault;
    if (dictData.status != null) insertObject.status = dictData.status;
    if (dictData.remark != null && dictData.remark != '')
      insertObject.remark = dictData.remark;
    if (dictData.createBy != null && dictData.createBy != '')
      insertObject.createBy = dictData.createBy;
  ...
  async updateDictData(dictData: SysDictData): Promise<number> {
    ...
    if (dictData.dictLabel != null && dictData.dictLabel != '')
      updateData.dictLabel = dictData.dictLabel;
    if (dictData.dictValue != null && dictData.dictValue != '')
      updateData.dictValue = dictData.dictValue;
    if (dictData.dictType != null && dictData.dictType != '')
      updateData.dictType = dictData.dictType;
    ...
    if (dictData.isDefault != null && dictData.isDefault != '')
      updateData.isDefault = dictData.isDefault;
    if (dictData.status != null) updateData.status = dictData.status;
    if (dictData.remark != null) updateData.remark = dictData.remark;
    if (dictData.updateBy != null && dictData.updateBy != '')
      updateData.updateBy = dictData.updateBy;
